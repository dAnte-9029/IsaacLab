...
def __getattr__(name: str):
    ...
    if name in (
        ...
        return {
            ...
            "FlappingBotStraightFlightDeLaurierMeasuredPureRLC3aEnvCfg": FlappingBotStraightFlightDeLaurierMeasuredPureRLC3aEnvCfg,
            "FlappingBotStraightFlightDeLaurierMeasuredPureRLC3bEnvCfg": FlappingBotStraightFlightDeLaurierMeasuredPureRLC3bEnvCfg,
            "FlappingBotStraightFlightDeLaurierMeasuredPureRLC3cEnvCfg": FlappingBotStraightFlightDeLaurierMeasuredPureRLC3cEnvCfg,
