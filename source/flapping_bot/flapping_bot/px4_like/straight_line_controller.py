...
class PX4LikeStraightLineControllerCfg:
    ...
    tecs_altitude_error_gain: float = 3.0
    tecs_airspeed_error_gain: float = 0.8
    tecs_pitch_speed_weight: float = 0.35
    tecs_pitch_damping_gain: float = 0.26
    ...
    tecs_altitude_hold_error_band_m: float = 0.05
    tecs_altitude_capture_error_m: float = 0.8
    tecs_altitude_capture_time_const_s: float = 0.45
    tecs_altitude_capture_release_error_m: float = 0.03
    tecs_altitude_capture_release_time_s: float = 0.35
    tecs_altitude_capture_persistence_gain: float = 1.0
    tecs_airspeed_error_gain_capture_scale: float = 0.35
    tecs_pitch_speed_weight_capture: float = 0.10
    tecs_capture_extra_climb_rate_mps: float = 1.4
    ...
    def __init__(self, cfg: PX4LikeStraightLineControllerCfg, device: torch.device):
        ...
        self._tecs = PX4LikeTECS(
            PX4LikeTECSCfg(
                ...
                altitude_capture_release_error_m=float(cfg.tecs_altitude_capture_release_error_m),
                altitude_capture_release_time_s=float(cfg.tecs_altitude_capture_release_time_s),
                altitude_capture_persistence_gain=float(cfg.tecs_altitude_capture_persistence_gain),
