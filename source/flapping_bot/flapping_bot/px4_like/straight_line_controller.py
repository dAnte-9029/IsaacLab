...
class PX4LikeStraightLineControllerCfg:
    ...
    tecs_altitude_error_gain: float = 1.8
    tecs_airspeed_error_gain: float = 0.8
    tecs_pitch_speed_weight: float = 0.5
    tecs_pitch_damping_gain: float = 0.16
    ...
    tecs_altitude_capture_time_const_s: float = 0.65
    tecs_airspeed_error_gain_capture_scale: float = 0.35
    tecs_pitch_speed_weight_capture: float = 0.25
    tecs_capture_extra_climb_rate_mps: float = 1.0
