...
# Ubuntu dual-GPU training launcher (torch.distributed.run + headless)
# Usage example:
#   chmod +x scripts/reinforcement_learning/rsl_rl/train_flapping_straightflight_dual_gpu.sh
#   ./scripts/reinforcement_learning/rsl_rl/train_flapping_straightflight_dual_gpu.sh --num_envs 1024 --max_iterations 2000
