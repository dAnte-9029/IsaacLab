...
def test_path_tracking_env_exposes_teacher_tecs_load_factor_defaults() -> None:
    ...
    expected_fields = {
        ...
        "teacher_guidance_min_ground_speed_mps": 0.0,
        "teacher_lateral_guidance_uncertainty_start_deg": 0.0,
        "teacher_lateral_guidance_uncertainty_full_deg": 0.0,
        "teacher_lateral_guidance_uncertainty_min_scale": 1.0,
...
def test_path_tracking_teacher_passes_tecs_load_factor_cfg_to_controller() -> None:
    ...
    expected_keywords = {
        ...
        "guidance_min_ground_speed_mps": "teacher_guidance_min_ground_speed_mps",
        "lateral_guidance_uncertainty_start_deg": "teacher_lateral_guidance_uncertainty_start_deg",
        "lateral_guidance_uncertainty_full_deg": "teacher_lateral_guidance_uncertainty_full_deg",
        "lateral_guidance_uncertainty_min_scale": "teacher_lateral_guidance_uncertainty_min_scale",
